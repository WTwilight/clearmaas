...
function PriceSection(props: {
  ...
  const effectiveRatio = getEffectiveRatio(props.model)
  const effectiveRatioMap = { [baseGroupKey]: effectiveRatio }
  ...
  if (dynamicSummary) {
    ...
    return (
      <section>
              ...
              >
                ...
                <div className='text-right'>
                  ...
                  <div className='text-foreground font-mono text-xl font-bold tabular-nums'>
                    {entry.formatted}
                    <span className='text-muted-foreground/40 ml-1 text-sm'>
                      / {tokenUnitLabel}
                    </span>
                  </div>
                </div>
        ...
        {hasDiscount && dynamicSummary.secondaryEntries.length > 0 && (
    ...
    <div className='@container/details space-y-4'>
      ...
      <Tabs defaultValue='overview' className='gap-4'>
        ...
        <TabsContent value='api' className='outline-none'>
          <ModelDetailsApi model={props.model} />
        </TabsContent>
      </Tabs>
    </div>
  )
