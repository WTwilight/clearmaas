...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/models/enabled", controller.ListEnabledModels)
		...
		supplierRoute.Use(middleware.AdminAuth())
		{
			...
			supplierRoute.GET("", controller.ListSupplier)
			...
			// Supplier pricing sheets (nested under supplier)
			supplierRoute.POST("/:id/pricing-sheet", controller.CreateSupplierPricingSheet)
			supplierRoute.GET("/:id/pricing-sheet", controller.ListSupplierPricingSheet)
			supplierRoute.GET("/:id/pricing-sheet/:sheetId", controller.GetSupplierPricingSheet)
			supplierRoute.PUT("/:id/pricing-sheet/:sheetId", controller.UpdateSupplierPricingSheet)
			supplierRoute.DELETE("/:id/pricing-sheet/:sheetId", controller.DeleteSupplierPricingSheet)
			// Supplier pricing items (nested under sheet)
			supplierRoute.POST("/:id/pricing-sheet/:sheetId/items", controller.AddSupplierPricingItem)
